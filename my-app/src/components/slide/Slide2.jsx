...
import popular from "C:/projects/GitHub/Online-shop-app/my-app/src/img/popular3.png";

const Slide2 = () => {
  return (
    <div className="flex flex-row items-center ">
      <div className="w-3/5">
        <img className="h-[700px] w-[500px] " src={popular} />
      </div>

      <div className="pr-40  flex flex-col gap-10 font-sans">
        <p className="font-semibold text-8xl ">POPULAR SALE</p>
